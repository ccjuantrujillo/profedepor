...
MySQL - 5.0.86-community-nt : Database - profedepor2
*********************************************************************
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='Resultados por partido por fase';
...
CREATE TABLE `depor_club` (
  ...
  `estado` char(1) default '1',
  PRIMARY KEY  (`club_id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='Clubes de football peruano';
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='Comentarios de los participantes.';
...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='Grupos de participantes.';
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='Jugador del juego.';
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='Jugadores por grupo\n';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Redes Sociales de un jugador.';
...
) ENGINE=InnoDB AUTO_INCREMENT=297 DEFAULT CHARSET=utf8 COMMENT='Puntaje de cada jugador por partido\n';
...
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8 COMMENT='Puntaje del jugador por partido por fase\n';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Lista de tipos de mail.';
...
set @s= CONCAT('select 
				*
				...
				and partido_id in (
					...
					and dp.fecha_id=',fechaid,'
					and dpj.jugador_id=',jugadorid,'
					and dvar.tipovariable_id=',tipo_id,'
					group by dp.partido_id
				)');
PREPARE stmt FROM @s;
EXECUTE stmt;
END */$$
