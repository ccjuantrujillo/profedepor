...
return array(
    // Zend_Filter_Input
    Zend_Filter_Input::MISSING_MESSAGE => " El campo '%field%' es requerido por la regla '%rule%'",
    # Zend_Filter_Input::NOT_EMPTY_MESSAGE   => "Ingrese un valor para '%field%'",
    Zend_Filter_Input::NOT_EMPTY_MESSAGE   => "Ingrese un valor",
